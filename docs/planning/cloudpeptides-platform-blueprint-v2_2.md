...
1. **Custom domain:** still undecided, confirmed non-blocking. Visual design, local development, route planning, and the staging build all proceed using a domain-neutral placeholder. No domain will be purchased, registered, connected, or configured until you confirm it.
