...
export default {
  ...
  sources: [
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'Continuous intranasal oxytocin treatment at the doses/duration studied could NOT be recommended for treating core social symptoms in adults with autism — a null result for the primary target, though some signal was suggested for repetitive behavior specifically.',
        limitations:
          'Single trial; other trials in this space show similarly inconsistent results across populations (children vs adults) and dosing.',
  ...
  claims: [
    ...
    },
    {
      ...
      qualityRationale:
        'Randomized, controlled, peer-reviewed human trial with a clear negative primary result for the specific outcome tested.',
  ...
  regulatoryRecords: [
    {
      ...
      formulation:
        'Oxytocin injection, USP (Pitocin, manufactured by Par Pharmaceutical/Par Sterile Products LLC, NDA 018261; and generics)',
      indication:
        'Induction/augmentation of labor; management of incomplete or inevitable abortion; control of postpartum hemorrhage',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Oxytocin Acetate is a synthetic form of oxytocin, a naturally occurring peptide hormone studied for its role in neuroendocrine signaling and hormone regulation',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Laboratory studies investigate oxytocin receptor activation, endocrine communication, and neurobiological pathways associated with behavioral and reproductive physiology',
      disposition: 'revised',
      rationale:
        'Accurate that this research exists, but omits that the flagship behavioral-application trial identified in this review (autism core symptoms) produced a null result — "investigate" alone risks implying an open or promising question rather than an area with a real negative finding.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'conflicting',
      sources: [{ sourceKey: 'pmid-29955161', relationship: 'contradicts' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate Oxytocin Acetate for its interaction with oxytocin receptors, which participate in endocrine signaling',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Oxytocin Acetate researched for? A: Research commonly focuses on neuroendocrine signaling, hormone regulation, reproductive biology, stress-response pathways, and social behavior models',
      disposition: 'revised',
      rationale:
        'Reproductive biology and hormone regulation are directly confirmed (and FDA-approved for specific obstetric uses). "Social behavior models" specifically has a real negative pivotal trial result that should not be omitted when this research area is mentioned.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'conflicting',
      sources: [
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Oxytocin Acetate a peptide hormone? A: Yes. Oxytocin is a naturally occurring peptide hormone',
      disposition: 'supported',
      rationale: 'Accurate.',
