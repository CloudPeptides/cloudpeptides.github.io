  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          '28 days of ARA 290 dosing significantly improved neuropathic symptoms versus placebo in patients with documented small nerve fiber loss.',
        limitations:
          'Small pilot trial (n=22); single-center-adjacent, sponsor-affiliated (Araim Pharmaceuticals) research network.',
    ...
    },
    {
      ...
      study: {
        ...
        route: 'Subcutaneous',
        primaryOutcomes:
          'Neuropathic symptom scores; corneal nerve fiber density (objective imaging measure)',
        resultsSummary:
          'ARA 290 improved neuropathic symptoms and increased corneal nerve fiber density (an objective, imaging-based measure of small-fiber regeneration) versus placebo.',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'Registration record corresponding to the corneal nerve fiber density trial (pmid-24136731).',
  ...
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale:
        'Randomized, double-blind, placebo-controlled design (a real strength), but small sample sizes and a single, sponsor-affiliated research network — not yet independently replicated by an unaffiliated group as of this review.',
    ...
    },
    {
      ...
      qualityRationale:
        'Consistent mechanistic rationale described across the clinical publications; this specific mechanistic claim was not independently re-verified against a dedicated in-vitro/receptor-binding source in this review.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'ARA-290 is a synthetic peptide engineered from erythropoietin-related research',
      disposition: 'supported',
      rationale:
        "Confirmed structural/design description and correctly notes it lacks erythropoietin's erythropoietic activity, consistent with verified sources.",
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Published research has explored ARA-290 in laboratory models involving neurologic biology, inflammation-related pathways, tissue repair, and microvascular function',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers study ARA-290 for its interaction with the innate repair receptor (IRR) pathway',
      disposition: 'supported',
      rationale:
        'Confirmed IRR-pathway mechanism, consistent with the clinical publications reviewed.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is ARA-290 erythropoietin? A: No. ARA-290 is a distinct synthetic peptide derived from erythropoietin research',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is ARA-290 researched for? A: Current research investigates tissue protection',
      disposition: 'supported',
      rationale:
        'Accurately summarizes the verified research focus (tissue protection, inflammation-related pathways, nerve biology) though "regenerative processes" is broader than what the clinical trials directly measured (symptom scores and corneal nerve fiber density specifically).',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [
        { sourceKey: 'pmid-23168581', relationship: 'directly_supports' },
