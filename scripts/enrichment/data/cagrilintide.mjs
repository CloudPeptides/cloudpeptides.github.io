...
export default {
  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          'Cagrilintide monotherapy produced dose-dependent weight loss significantly greater than placebo in this Phase 2 dose-finding trial.',
        limitations:
          'Phase 2, not yet Phase 3-confirmed as monotherapy (subsequent development combined it with semaglutide rather than pursuing cagrilintide alone); industry-funded (Novo Nordisk).',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'Phase 1b trial establishing that co-administered cagrilintide + semaglutide was safe and tolerable, supporting progression to larger efficacy trials (the "CagriSema" program).',
    ...
    },
    {
      ...
      study: {
        ...
        duration: '32 weeks',
        resultsSummary:
          'CagriSema produced significantly greater weight loss than either semaglutide or cagrilintide alone in adults with type 2 diabetes; HbA1c improvement was greater than cagrilintide alone but not significantly different from semaglutide alone.',
    ...
    },
    {
      ...
      study: {
        ...
        primaryOutcomes: 'Percent change in body weight',
        resultsSummary:
          "CagriSema produced significant, clinically relevant body-weight reduction versus placebo in this Phase 3 trial — the pivotal trial underlying Novo Nordisk's FDA New Drug Application.",
        limitations:
          "Industry-funded (Novo Nordisk); as with all combination-product trials here, isolates the combination's effect, not cagrilintide monotherapy's effect specifically.",
  ...
  claims: [
    ...
    },
    {
      ...
      qualityRationale:
        'Multiple large, randomized, double-blind, placebo-controlled trials including a Phase 3 pivotal trial in a top-tier journal — but all industry-funded (Novo Nordisk), and not yet FDA-approved.',
      interpretationStatus: 'supported',
      sources: [
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Cagrilintide is a long-acting amylin analogue being investigated for its role in appetite regulation and metabolic physiology',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Because it acts through a pathway different from GLP-1 receptor agonists, Cagrilintide is frequently investigated alongside other metabolic compounds',
      disposition: 'supported',
      rationale:
        "Confirmed — cagrilintide's primary clinical development pathway is specifically its combination with the GLP-1 agonist semaglutide (CagriSema).",
      evidenceQuality: 'high',
      interpretationStatus: 'supported',
      sources: [
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Cagrilintide is designed to mimic the hormone amylin. Researchers investigate how amylin receptor activation influences appetite',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What does Cagrilintide target? A: Cagrilintide is an amylin analogue investigated for its effects on amylin signaling',
      disposition: 'supported',
