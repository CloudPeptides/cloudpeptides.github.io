  ...
  sources: [
    ...
    },
    {
      ...
      study: {
        ...
        intervention: 'BPC 157 — intraperitoneal (10 microg or 10 ng/kg), topical cream (1.0 microg/g), or oral (in drinking water)',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary: 'BPC 157 improved functional recovery and healing of surgically transected quadriceps muscle.',
    ...
    },
    {
      ...
      study: {
        ...
        intervention: 'BPC 157 (10 microg, 10 ng, or 10 pg/kg) alone or combined with 6alpha-methylprednisolone (1 mg/kg)',
        ...
        limitations: 'Animal model only; exact per-group sample size not stated in the abstract reviewed.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
    ...
    },
    {
      ...
      study: {
        ...
        sampleSize: 2,
        intervention: 'Intravenous BPC-157: 10 mg on day 1, 20 mg on day 2, in 250cc normal saline over 1 hour',
        route: 'Intravenous',
        primaryOutcomes: 'Cardiac, hepatic, renal, thyroid biomarkers; blood glucose; adverse events',
        resultsSummary:
    ...
    },
    {
      ...
      study: {
        ...
        limitations: 'Trial in progress — recruiting status only, no efficacy or safety results available yet.',
  ...
  claims: [
    {
      ...
      qualityRationale: 'Peer-reviewed in-vitro mechanistic study; not independently replicated in this review.',
    ...
    },
    {
      ...
      evidenceQuality: 'moderate',
      qualityRationale: 'Peer-reviewed in-vitro mechanistic study from the same research group as related tendon-healing studies.',
      interpretationStatus: 'preliminary',
