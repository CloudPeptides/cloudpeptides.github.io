  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          'See ghk-cu.mjs for the fuller GHK-Cu evidence base (fibroblast/collagen/MMP effects).',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'See bpc-157-tb-500.mjs for the fuller thymosin beta-4/TB-500 evidence base (wound reepithelialization, collagen, angiogenesis).',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Glow Blend combines GHK-Cu and TB-500, two compounds frequently discussed in research settings involving tissue remodeling, collagen biology',
      disposition: 'revised',
      rationale:
        'Each compound individually has real literature in these areas (confirmed separately). The claim that they are "frequently discussed" together in research settings is not itself evidence the combination has been studied — no combination study was located.',
      evidenceQuality: 'low',
      interpretationStatus: 'insufficient',
      sources: [
        { sourceKey: 'pmid-11045606-glow', relationship: 'provides_context' },
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers study this combination to better understand how copper peptide signaling and actin-related cellular movement may contribute to connective tissue biology',
      disposition: 'unsupported',
      rationale:
        "No study of the combination's interaction was located — each mechanism (copper-peptide signaling; actin-related cellular movement) has been studied only for its respective individual compound.",
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why are GHK-Cu and TB-500 researched together? A: Researchers investigate this pairing because the compounds are associated with different but complementary areas',
      disposition: 'revised',
      rationale:
        'A plausible product-design rationale, not evidence the pairing itself has been researched together.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Glow Blend the same as GHK-Cu alone? A: No. Glow Blend refers to a combination product',
