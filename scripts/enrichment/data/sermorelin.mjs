  ...
  sources: [
    {
      ...
      title: 'Determination That GEREF (Sermorelin Acetate) Injection... Were Not Withdrawn From Sale for Reasons of Safety or Effectiveness',
  ...
  claims: [
    {
      ...
      qualityRationale: 'Established, uncontested pharmacology, confirmed by its historical FDA approval and labeling for this exact mechanism/use.',
  ...
  regulatoryRecords: [
    {
      ...
      indication: 'Idiopathic growth hormone deficiency in children (treatment, NDA 20-443); diagnostic evaluation of pituitary GH secretion (NDA 19-863)',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Sermorelin is a synthetic analog of growth hormone-releasing hormone (GHRH)',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Published research explores its role in endocrine physiology, IGF-1 biology, body composition, recovery, and healthy aging',
      disposition: 'revised',
      rationale: 'Endocrine physiology/GH-IGF-1 biology is directly confirmed by its historical approved use (pediatric GHD diagnosis/treatment). "Body composition, recovery, and healthy aging" specifically were not verified as approved indications or as directly-studied outcomes in the source identified in this review.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Sermorelin activates GHRH receptors within the pituitary gland, promoting physiologic growth hormone release',
      disposition: 'supported',
      rationale: 'Confirmed mechanism, consistent with its historical approved use for exactly this purpose.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'fedreg-geref-2013', relationship: 'provides_context' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is Sermorelin growth hormone? A: No. Sermorelin is a GHRH analog researched for stimulating the body\'s own growth hormone release',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is its primary research target? A: Its primary research target is the growth hormone-releasing hormone receptor (GHRH receptor)',
      disposition: 'supported',
      rationale: 'Confirmed.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
    ...
    policyReconciliation('c772ea59-0b85-4801-99b4-5ae8089fefeb', 'Q: Does this page include dosage information? A: No.'),
    policyReconciliation('fb538f65-ef83-4a39-bb65-7db259dd1911', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('79bf0e05-5684-42f4-8423-3392e0f516d8', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    {
