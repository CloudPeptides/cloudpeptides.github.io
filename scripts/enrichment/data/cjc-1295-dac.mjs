  ...
  sources: [
    {
      ...
      study: {
        ...
        intervention:
          'CJC-1295 (DAC-conjugated long-acting GHRH analog), single and multiple ascending-dose injections',
        comparator: 'Placebo',
        ...
        limitations:
          'Sponsor-affiliated authors (drug developer, ConjuChem); healthy-adult population, not a specific patient population; longer-term (beyond ~28-49 days) safety not assessed in this trial.',
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Randomized, placebo-controlled human trial published in a peer-reviewed endocrinology journal — but sponsor-affiliated, small/short-duration, and in healthy volunteers rather than a target patient population.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'CJC-1295 DAC is a synthetic GHRH analog studied for its ability to stimulate growth hormone release through the GHRH receptor',
      disposition: 'supported',
      rationale:
        'Directly confirmed by the pivotal human trial for this specific (DAC-conjugated) form.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
      sources: [{ sourceKey: 'pmid-16352683', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate CJC-1295 DAC in relation to growth hormone physiology, IGF-1 signaling, endocrine regulation, body composition, recovery biology, and healthy aging',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'CJC-1295 DAC binds to GHRH receptors and is studied for stimulating growth hormone release',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What does DAC mean? A: DAC stands for Drug Affinity Complex. It is researched for its effect on circulation time',
      disposition: 'supported',
      rationale:
        'Confirmed — the verified trial directly measured the prolonged half-life (5.8-8.1 days) attributable to the DAC conjugation.',
      evidenceQuality: 'moderate',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: How is CJC-1295 DAC different from CJC-1295 No DAC? A: The DAC version is studied for longer duration',
      disposition: 'supported',
      rationale:
        'Confirmed for the DAC version by the verified trial; see cjc-1295-no-dac.mjs for the corresponding No-DAC-side reconciliation.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
      sources: [{ sourceKey: 'pmid-16352683', relationship: 'directly_supports' }],
    },
    policyReconciliation(
      '0e191d00-881e-4bc4-88e9-135f88083f4e',
      'Q: Does this page include dosage information? A: No.',
    ),
    policyReconciliation(
      '7dad50d1-add1-4428-a55b-2c5d58a20c27',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '3413f3fb-27a6-4329-a01d-0d576633ed67',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      'bc4132c1-a795-496b-a860-fa28815e6fa9',
