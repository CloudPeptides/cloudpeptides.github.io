  ...
  sources: [
    {
      ...
      // PMC open-access full-text mirror — see tesamorelin.mjs's own
      // comment; both compounds share this one `sources` row (globally
      // unique PMID/DOI identifiers), corrected 2026-08-08.
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary:
          'Tesamorelin significantly reduced visceral adipose tissue and liver fat versus placebo. See tesamorelin.mjs (forthcoming) for the fuller Tesamorelin evidence base and FDA approval record.',
        limitations:
          'Studies Tesamorelin as monotherapy — no arm tested co-administration with CJC-1295 No DAC or any other GHRH analog.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'The Growth Hormone Fat Loss Stack combines Tesamorelin and CJC-1295 no DAC, two compounds commonly investigated for their influence on growth hormone physiology',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers study this pairing to better understand growth hormone signaling, IGF-1 biology, visceral adipose tissue research',
      disposition: 'unsupported',
      rationale:
        'No study of "this pairing" was located; visceral-adipose-tissue evidence exists for Tesamorelin alone, not the pairing.',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Scientific understanding continues to evolve, and findings should always be interpreted within the context of each individual study',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate this combination because Tesamorelin and CJC-1295 no DAC are both associated with growth hormone-related signaling',
      disposition: 'unsupported',
      rationale:
        'No source investigating "this combination" was located — each compound has been investigated independently, and with very different levels of evidentiary support (see above).',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why are these compounds researched together? A: Researchers study them together because both compounds are associated with growth hormone pathways',
      disposition: 'revised',
      rationale:
        'A plausible product-design rationale, not evidence the pairing itself has been researched — and notably pairs an FDA-approved drug with an unverified research-chemical product without any studied combination data.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    policyReconciliation(
      '3b706de9-b875-4945-b2f3-00b4c64b628a',
      'Q: Does Cloud Peptides recommend this stack? A: No.',
    ),
    policyReconciliation(
      '1633f034-f860-4ee3-a3df-c5f2a45e1ef8',
      'Q: Does this page provide dosage information? A: No.',
    ),
    policyReconciliation(
      '9b556e0a-fb84-4bbf-a733-ea3c8185aaf7',
      'Q: Are these products intended for human consumption? A: No.',
    ),
    policyReconciliation(
      'e665ebe8-287a-462b-a1b3-bc4b930a41cc',
      'This page summarizes published scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '562c5dc2-5d1f-473a-8131-0caede94dfa2',
      'Cloud Peptides does not provide medical advice, dosage recommendations, treatment advice',
    ),
    policyReconciliation(
      'b6c52ba1-f08e-40c8-a6a6-602d97cb73ea',
