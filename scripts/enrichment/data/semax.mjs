...
export default {
  ...
  sources: [
    {
      ...
      study: {
        ...
        population: 'Adult humans in the acute period of hemispheric ischemic stroke (30 treated; 80 concurrent controls matched for severity/location)',
        sampleSize: 30,
        intervention: 'Semax added to combined intensive stroke therapy',
        comparator: 'Conventional therapy alone (80 patients, matched for stroke severity and lesion location, not described as randomized or blinded)',
        primaryOutcomes: 'Clinical neurological rating scales; EEG mapping; somatosensory evoked potentials and their mapping',
        resultsSummary:
    ...
    },
    {
      ...
      study: {
        ...
        limitations: 'Animal (rat) study; mechanistic, not a measure of clinical cognitive outcome.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        intervention: 'Semax',
        resultsSummary: 'Semax modulated striatal dopaminergic and serotoninergic activity, proposed as a contributor to its nootropic effects.',
    ...
    },
    {
      ...
      study: {
        ...
        limitations: 'Animal study; mechanistic; head-to-head comparator (glycine) was not itself validated as an effective agent in this model.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        studyDesign: 'animal_study',
        population: 'Rat, cerebral ischemia-reperfusion (middle cerebral artery occlusion-type model)',
        ...
        limitations: 'Animal study; mechanistic/omics-level evidence, not a clinical outcome measure.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
  ...
  claims: [
    ...
    },
    {
      ...
      qualityRationale: 'Peer-reviewed animal mechanistic studies from independent research groups; not evidence of a human cognitive outcome.',
      interpretationStatus: 'preliminary',
      sources: [
    ...
    },
    {
      ...
      evidenceQuality: 'moderate',
      qualityRationale: 'Peer-reviewed animal mechanistic studies from independent research groups spanning two decades; consistent direction of effect.',
      interpretationStatus: 'preliminary',
      sources: [
    ...
    },
    {
      ...
      qualityRationale: 'Narrative review authored by the compound\'s original inventors (direct conflict of interest); not a systematic safety review or a controlled trial; no adverse-event methodology described in the abstract reviewed.',
