  ...
  claims: [
    {
      ...
      qualityRationale: 'Consistent, well-described mechanism across the reviewed regulatory/clinical literature; this specific mechanistic claim was not independently re-verified against a dedicated basic-science source in this review.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'SS-31 is a mitochondria-targeted peptide studied for its relationship to mitochondrial membrane biology, oxidative stress, and cellular energy production',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate SS-31 in laboratory models involving mitochondrial dysfunction, cardiometabolic biology, neurobiology, skeletal muscle physiology, and healthy aging',
      disposition: 'revised',
      rationale: 'The Barth syndrome (skeletal muscle strength) indication is directly confirmed by the actual approval. Other listed research areas (cardiometabolic, neurobiology, healthy aging) were not independently re-verified as approved indications in this review — those remain research-stage uses distinct from the approved indication.',
      evidenceQuality: 'moderate',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'SS-31 is studied for its interaction with cardiolipin, a phospholipid found in the inner mitochondrial membrane',
      disposition: 'supported',
      rationale: 'Directly confirmed mechanism, consistent with the approved indication\'s underlying disease mechanism (Barth syndrome is itself a cardiolipin-metabolism disorder).',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
      sources: [{ sourceKey: 'pmid-41335372', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is SS-31 researched for? A: Research commonly focuses on mitochondrial function, oxidative stress, cardiolipin biology, cellular energy, and healthy aging models',
      disposition: 'revised',
      rationale: 'Accurate as far as the research base goes, but again omits the September 2025 FDA approval — the single most important update to this compound\'s status.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-41335372', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is SS-31 the same as Elamipretide? A: SS-31 is commonly discussed in the scientific literature under the name Elamipretide',
      disposition: 'supported',
      rationale: 'Accurate and confirmed — elamipretide is the formal pharmaceutical name used in the approval.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-41335372', relationship: 'directly_supports' }],
    },
    policyReconciliation('8598ad44-ed16-4755-80b0-d0cde7282203', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('25e1da35-8abd-45ad-91aa-9dd0ada853a0', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('2befd2cf-42fe-426d-a76e-7e0ab069e897', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    {
