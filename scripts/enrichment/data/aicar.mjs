  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations:
          'Mouse study only; the exercise-mimetic effect has not been demonstrated in a published human trial.',
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Peer-reviewed, in a top-tier journal (Cell) for the primary finding; consistent, independently replicated direction of effect across two studies — but animal-only.',
  ...
  regulatoryRecords: [
    {
      ...
      notes:
        'Classified under the Hormone and Metabolic Modulators category on the WADA Prohibited List, prohibited at all times, per USADA athlete guidance. Not approved for human therapeutic use by any governmental regulatory authority.',
    },
  ],
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'AICAR is widely studied as an activator of AMP-activated protein kinase (AMPK)',
      disposition: 'supported',
      rationale:
        'Confirmed AMPK-activator mechanism, correctly framed as research (not a human-efficacy claim).',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Because AMPK acts as an intracellular energy sensor, AICAR continues to be explored in laboratory studies',
      disposition: 'supported',
      rationale:
        'Correctly hedged as laboratory (not human) research; consistent with the verified animal evidence base.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'AICAR is converted inside cells into a molecule capable of activating AMPK',
      disposition: 'supported',
      rationale:
        'Consistent with the well-established AICAR-to-ZMP-to-AMPK-activation mechanism described in the verified sources.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-18674809', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is AICAR primarily researched for? A: Most research focuses on AMPK activation',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is AICAR a peptide? A: No. AICAR is a small-molecule research compound',
      disposition: 'supported',
      rationale:
        'Chemical classification fact (a nucleotide/ribonucleoside analog, not an amino-acid chain) verifiable by structure.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [],
    },
    policyReconciliation(
      '7a63e133-b236-429d-acf3-267c457a097a',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      '5117c83e-c946-4d33-8ed5-467627e625cb',
      'This page summarizes published scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '118d2c0e-848b-4f32-974f-3a5c4d0b6255',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      '44993f1b-f4ca-4c2d-b69e-4c9bd0a4508a',
