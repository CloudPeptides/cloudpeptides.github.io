  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary: 'Reduced body-weight gain by over 50% versus control, without adversely affecting insulin sensitivity (assessed by euglycemic clamp).',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary: 'Both hGH and AOD9604 increased repressed beta(3)-AR mRNA levels in obese mice toward lean-control levels, a proposed mechanism for AOD9604\'s lipolytic effect without hGH\'s growth-promoting activity.',
        limitations: 'Mouse study only.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        population: 'Healthy adults, primarily obese (BMI 30-35), ages 18-65, both sexes; pooled across 6 trials',
        sampleSize: 893,
        intervention: 'AOD9604, IV infusion (25-400 microg/kg) or oral (0.25-54 mg/day) across six Phase I/IIa/IIb randomized, double-blind, placebo-controlled trials',
        comparator: 'Placebo',
        route: 'Intravenous and oral',
        primaryOutcomes: 'Safety, tolerability, adverse events, IGF-1 levels, glucose tolerance, anti-AOD9604 antibody formation',
        resultsSummary:
        ...
        limitations: 'Safety/tolerability pooled analysis, not an efficacy trial; company-sponsor-affiliated authors (former Metabolic Pharmaceuticals personnel).',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
  ...
  claims: [
    {
      ...
      qualityRationale: 'Peer-reviewed animal mechanistic and metabolic studies; consistent across two independent groups.',
    ...
    },
    {
      ...
      qualityRationale: 'Large, multi-trial, randomized, placebo-controlled human safety dataset — one of the more complete human safety records among compounds reviewed in this pipeline, though sponsor-affiliated.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'AOD-9604 is a modified fragment of human growth hormone investigated primarily for metabolic and adipose tissue research',
      disposition: 'supported',
      rationale: 'Accurately describes AOD9604 as a metabolic/adipose research fragment rather than a growth-promoting hGH product; consistent with the verified mechanistic literature.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [
        { sourceKey: 'pmid-11146367', relationship: 'directly_supports' },
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Research continues to explore its role in body composition, energy balance, and metabolic physiology',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate AOD-9604 for its potential interactions with pathways involved in fat metabolism',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is AOD-9604 full-length growth hormone? A: No. It is a peptide fragment derived from human growth hormone',
      disposition: 'supported',
    ...
    policyReconciliation('05492841-cfb3-4e90-9fc1-310117349944', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('a9dee20e-3a1c-44bf-afb4-b862775725db', 'Q: What is this page for? A: This page summarizes publicly available scientific literature'),
    policyReconciliation('9e203bd9-d2f6-403c-8a5f-2d670686586a', 'This page is provided for educational purposes only.'),
    policyReconciliation('ee11ec23-2cde-44ff-a524-0dfbffb2e2be', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('b6004b1c-01fe-4f3c-8b8f-625fdb392c23', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
