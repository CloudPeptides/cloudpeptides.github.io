  ...
  sources: [
    {
      ...
      study: {
        ...
        population: 'Human hair follicles (ex vivo organ culture) and cultured human dermal papilla cells (DPCs)',
        intervention: 'AHK-Cu (L-alanyl-L-histidyl-L-lysine-Cu2+), concentrations 10^-12 to 10^-9 M',
        resultsSummary:
  ...
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Single peer-reviewed ex vivo/in vitro study; not replicated; not an in vivo or clinical (scalp) outcome.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'AHK-Cu is a naturally occurring copper-binding tripeptide investigated for its role in skin biology, connective tissue research, hair follicle physiology',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate AHK-Cu for its interaction with copper-dependent signaling pathways involving fibroblast activity',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is AHK-Cu? A: AHK-Cu is a copper-binding peptide studied for skin biology, tissue remodeling, and hair follicle research',
      disposition: 'revised',
      rationale: 'Hair follicle research is verified. "Skin biology" and "tissue remodeling" beyond the hair follicle context are not independently verified for AHK-Cu specifically in this review — see note on the summary claim above.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-17703734', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: How is AHK-Cu different from GHK-Cu? A: Although both are copper peptides, they are distinct molecules',
      disposition: 'supported',
      rationale: 'Accurately and conservatively hedged — correctly states they are distinct molecules with overlapping but different pathways, without overclaiming equivalence. Consistent with this review\'s own finding that AHK-Cu\'s verified evidence base does not extend to all of GHK-Cu\'s findings.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-17703734', relationship: 'provides_context' }],
    },
    policyReconciliation('abe0bbf7-2fc1-43bd-8357-4d8cab95e9f6', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('31fe6c35-07f9-4b8c-a7ce-2c320e4199cc', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('5f69cc37-08df-406c-af0c-222def9c8770', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('8812b934-8b15-49c4-b2f0-2bfc7acb29d6', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
