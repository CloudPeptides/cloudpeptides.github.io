  ...
  sources: [
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        route: 'Oral',
        resultsSummary: 'No significant changes were observed in oxidative-stress biomarkers, including glutathione status itself, with oral supplementation.',
        limitations: 'Negative/null result in healthy volunteers; does not rule out effects in a deficient or diseased population.',
    ...
    },
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        route: 'Oral',
        resultsSummary: 'Reported skin-lightening effect versus placebo in a small number of subjects.',
        limitations: 'Small trial; a separate independent publication (not directly re-verified in this review) has specifically flagged INTRAVENOUS glutathione for skin lightening as having inadequate safety data — that caution applies to the IV route, not necessarily this oral trial.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Randomized, placebo-controlled trials exist on both sides of the question, with genuinely conflicting results depending on outcome measured (systemic oxidative-stress biomarkers vs. skin pigmentation specifically) and population.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Glutathione is an endogenous tripeptide widely studied for its central role in antioxidant defense and cellular homeostasis',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Because glutathione is present throughout the body, it has become one of the most extensively researched molecules in cellular health',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate glutathione for its ability to participate in redox reactions, neutralize reactive oxygen species',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is glutathione researched for? A: Research commonly focuses on antioxidant biology, oxidative stress, mitochondrial function',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is glutathione naturally produced? A: Yes. It is a naturally occurring tripeptide found in cells throughout the body',
      disposition: 'supported',
    ...
    policyReconciliation('8330d6fe-3a01-4a3e-86e8-236c519290ba', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('d28b31dc-c1ae-456b-a24d-99d24dbfccad', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('a51517e1-0b53-4055-8239-a76bd9702ff5', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('26e529a8-e4b2-40dd-89b2-b5978e642a8d', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
