  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations: 'Mouse study only; no human data. Industry-affiliated authors (compound developer).',
    ...
    },
    {
      ...
      study: {
        ...
        limitations: 'Mouse study only; microbiome association, not a measure of a specific human health outcome.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      qualityRationale: 'Peer-reviewed mechanistic characterization, though from the compound-developer\'s own research group.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: '5-Amino-1MQ is a research compound studied primarily for its ability to inhibit nicotinamide N-methyltransferase',
      disposition: 'supported',
      rationale: 'Confirmed by peer-reviewed literature: 5-Amino-1MQ is indeed an NNMT inhibitor. The statement itself makes no efficacy claim beyond identifying the research target, so it is fully supported as written.',
      evidenceQuality: 'moderate',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate how modulation of NNMT activity may influence adipose tissue biology',
      disposition: 'supported',
      rationale: 'Consistent with verified mouse-model findings on adiposity and body-composition changes with NNMT inhibition. Correctly hedged as laboratory-model research, not a human efficacy claim.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Current research focuses on inhibition of NNMT, an enzyme associated with nicotinamide metabolism',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is 5-Amino-1MQ a peptide? A: No. It is a small-molecule research compound',
      disposition: 'supported',
      rationale: 'Chemical classification fact (5-amino-1-methylquinolinium is a small heterocyclic molecule, not an amino-acid chain/peptide), verifiable by structure rather than requiring a literature citation.',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is its primary research target? A: Most published research focuses on inhibition of the NNMT enzyme',
      disposition: 'supported',
    ...
    policyReconciliation('e93281ba-9dbe-4c26-9aa7-664f31fbe669', 'Q: Does Cloud Peptides provide dosage recommendations? A: No.'),
    policyReconciliation('69f24b96-687b-4f16-81c4-77ee6c6fe742', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('feaa03dd-2a69-419a-ab61-732df21b9e70', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('24290fd7-5c75-44de-9374-4e6615ed4c8d', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
