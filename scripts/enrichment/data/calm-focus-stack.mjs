  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          "Reviews Selank's proposed anxiolytic mechanism (GABAergic modulation) and preclinical/some clinical findings.",
    ...
    },
    {
      ...
      study: {
        ...
        limitations:
          'Published in a Russian-language journal; this review relied on the English abstract, not the full primary text; study design details (randomization/blinding) not confirmed from the abstract alone.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'The Calm Focus Stack combines Selank and Semax, two synthetic peptides that have become common subjects of neuroscience research',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Although the compounds are frequently paired, they are believed to influence different biological systems',
      disposition: 'supported',
      rationale:
        'Accurately hedged ("believed to", not claiming direct combination evidence) and consistent with each peptide\'s distinct, separately-verified mechanism.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Research in this area continues to evolve, and findings should always be interpreted within the context of published scientific literature',
      disposition: 'supported',
      rationale:
        "Generic, appropriately cautious statement; consistent with this review's own findings.",
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers commonly investigate Selank and Semax together because each has been associated with different aspects of neuroscience',
      disposition: 'unsupported',
      rationale:
        'No source located actually investigating Selank and Semax "together" as a combination — each has been investigated independently. The premise of joint investigation is not verified.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why are Selank and Semax researched together? A: Researchers study this pairing because the compounds are associated with complementary areas',
      disposition: 'revised',
      rationale:
        'As with the mechanism claim above — this is a plausible commercial rationale for pairing them, not evidence that the pairing itself has been "researched." Best understood as a marketing/product-design rationale, not a scientific claim.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    policyReconciliation(
      'cae25943-a441-4785-b753-603b4c2a54f1',
      'Q: Does Cloud Peptides recommend this stack? A: No.',
    ),
    policyReconciliation(
      '729ccdcd-5607-4eb8-9f15-4dcb3263f1c1',
      'Q: Does this article contain dosage recommendations? A: No.',
    ),
    policyReconciliation(
      'acf9c8db-124f-45e4-a02a-ec8071e5c898',
      'Q: Are these products intended for human consumption? A: No.',
    ),
    policyReconciliation(
      'f5a2a2b3-1965-4d4a-a688-f26d4e65885f',
      'This page summarizes published scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '4dacd895-a78e-4fd2-8bee-87fff6a60693',
      'Cloud Peptides does not provide medical advice, dosage recommendations, treatment guidance',
    ),
    policyReconciliation(
      'e0efb71f-8562-4e91-a84f-291dbf9d9053',
