  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations: 'Very small sample (n=6); acute IV administration, not representative of any commercial oral/subcutaneous use.',
    ...
    },
    {
      ...
      study: {
        ...
        limitations: 'Small sample (n=16); authors\' own stated caveat about weak/uncertain significance is preserved rather than omitted.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        route: 'Intravenous',
        resultsSummary: 'Longer sleep duration and higher-quality sleep with fewer interruptions, and slightly more REM sleep, with no daytime sedation or reported side effects.',
  ...
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Randomized, placebo-controlled design (a genuine strength) but very small samples, decades-old trials, intravenous route not representative of commercial use, and the authors\' own explicit caution about the strength/reliability of their positive findings.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'DSIP is a regulatory peptide investigated in sleep and neuroendocrine research',
      disposition: 'supported',
      rationale: 'Confirmed — DSIP has real human trial evidence in sleep research, unusual among the peptides in this database for having decades-old human data.',
      evidenceQuality: 'low',
      interpretationStatus: 'conflicting',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Laboratory research continues to explore DSIP in models involving restorative physiology, neuropeptide regulation, and behavioral neuroscience',
      disposition: 'revised',
      rationale: 'DSIP\'s human sleep trials date from the 1980s-90s; this review found no evidence of substantial ongoing ("continues to explore") active research since — represented here as historical rather than ongoing.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate DSIP for its potential influence on neuroendocrine pathways associated with sleep regulation',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is DSIP researched for? A: Research commonly focuses on sleep biology, circadian rhythm, stress-response pathways',
      disposition: 'supported',
      rationale: 'Accurately reflects the actual (older) research base, though "circadian rhythm" and "stress-response pathways" specifically were not directly measured in the verified sleep trials — this review verified sleep-parameter outcomes specifically.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-1299794', relationship: 'directly_supports' }],
    },
    ...
    policyReconciliation('d3935dfe-0c99-4a37-9e64-a72df07a0959', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('3fe613b5-a7b5-4a9d-bd86-d11efc018d78', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('afa96b28-e6db-4a2e-a25b-f52ffce5132e', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('9add4a7b-3435-4909-bbf8-224bef2c1094', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
