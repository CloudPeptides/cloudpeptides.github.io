  ...
  claims: [
    {
      ...
      qualityRationale:
        "Reviewed/reported by the compound's own developers (Khavinson group) — a direct conflict of interest; cell-culture (in-vitro) evidence only; a small overall literature footprint (~22 PubMed records) with minimal independent outside replication identified in this review.",
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Pinealon is a short peptide investigated in laboratory models involving nervous system biology, cellular aging, and regulatory peptide signaling',
      disposition: 'revised',
      rationale:
        "The described research focus is accurate, but the strength/independence of the evidence should be caveated: the identified literature is small and predominantly self-authored by the compound's own developers, not independently replicated outside that group.",
      evidenceQuality: 'very_low',
      interpretationStatus: 'insufficient',
      sources: [{ sourceKey: 'pmid-33396470', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Scientific interest focuses on how short regulatory peptides may influence gene expression, cellular communication, neurobiology, and healthy aging models',
      disposition: 'supported',
      rationale:
        "Consistent with the verified mechanistic literature's proposed gene-expression-regulation hypothesis.",
      evidenceQuality: 'very_low',
      interpretationStatus: 'insufficient',
      sources: [{ sourceKey: 'pmid-33396470', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate Pinealon for its potential influence on peptide-mediated signaling and gene expression patterns',
      disposition: 'supported',
      rationale:
        "Directly confirmed by the verified source's proposed mechanism, with the same conflict-of-interest/replication caveat noted above.",
      evidenceQuality: 'very_low',
      interpretationStatus: 'insufficient',
      sources: [{ sourceKey: 'pmid-33396470', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Pinealon researched for? A: Research commonly focuses on neurobiology, cellular aging, brain tissue models, gene expression, and longevity-related pathways',
      disposition: 'revised',
      rationale:
        'Accurate research focus, but the "longevity-related pathways" framing is not directly evidenced by the specific Alzheimer\'s-mechanism source verified here — that source concerns neuroprotection/oxidative stress specifically, not a longevity/lifespan outcome.',
      evidenceQuality: 'very_low',
      interpretationStatus: 'insufficient',
      sources: [{ sourceKey: 'pmid-33396470', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Pinealon related to Epithalon? A: They are distinct short peptides, but both are often discussed within broader longevity and regulatory peptide research',
      disposition: 'supported',
      rationale:
        'Accurate — both are Khavinson-group short-chain peptides with similar evidentiary profiles (small, largely self-authored literature); correctly notes they are chemically distinct.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-33396470', relationship: 'provides_context' }],
    },
    policyReconciliation(
      '5ef69326-ee3a-4612-9c67-7e102275d72f',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      'df1fea77-a3b9-45ae-91d5-efe72cd9fa11',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '1dcbe4fd-474a-4055-9835-04dcedb3aed1',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      '0c3d732e-e011-426d-8690-f09fda87a231',
