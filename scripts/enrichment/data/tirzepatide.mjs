...
export default {
  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          'Tirzepatide produced substantial, sustained, dose-dependent reductions in body weight versus placebo over 72 weeks — the pivotal trial underlying its 2023 FDA approval for chronic weight management (Zepbound).',
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Well-established mechanism directly confirmed by the FDA-approved label and multiple Phase 3 trials.',
    ...
    },
    {
      ...
      evidenceQuality: 'high',
      qualityRationale:
        'Large, randomized, double-blind, placebo-controlled Phase 3 trial published in a top-tier peer-reviewed journal (NEJM) — pivotal-trial-grade evidence.',
      interpretationStatus: 'established',
  ...
  regulatoryRecords: [
    ...
    },
    {
      ...
      sourceKey: 'fda-mounjaro-label',
      notes:
        'Third approved indication, same manufacturer (Eli Lilly and Company). Approval date per secondary corroboration, not independently re-verified against a dedicated FDA label document in this review. Same regulatory-identity caveat as Mounjaro applies.',
    },
  ],
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Tirzepatide is an investigational peptide that activates both GLP-1 and GIP receptors',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Because it targets two complementary metabolic pathways, Tirzepatide has become one of the most extensively researched compounds in obesity and metabolic science',
      disposition: 'supported',
      rationale:
        'Accurate — confirmed by the scale of the SURMOUNT/SURPASS clinical trial programs and its regulatory approval history.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-35658024', relationship: 'directly_supports' }],
    },
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What receptors does Tirzepatide target? A: Tirzepatide is designed to activate GLP-1 and GIP receptors for research purposes',
      disposition: 'supported',
      rationale:
    ...
    policyReconciliation(
      '1f7c9115-ae92-496e-b1ea-17a12ba09a9d',
      'Q: Does Cloud Peptides provide dosing information? A: No.',
    ),
    policyReconciliation(
      '2354fdc6-1a6c-43d3-a1ac-0f3f7c4011e9',
      'Q: Is this article educational? A: Yes.',
    ),
    policyReconciliation(
      '1e5b81c7-94d9-46bd-ad6e-151d9e0f0d6e',
      'This page is provided for educational purposes only.',
    ),
    policyReconciliation(
      'a79ff775-6a03-48a0-858b-b8a4732832b0',
