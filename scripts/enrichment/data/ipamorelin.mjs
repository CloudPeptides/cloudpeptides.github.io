  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          'Established Ipamorelin as a selective growth hormone secretagogue with high GH-releasing potency and efficacy, with minimal effect on other pituitary hormones (e.g., ACTH/cortisol) compared to earlier, less selective secretagogues.',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'Established a PK/PD model for Ipamorelin-stimulated GH release in healthy human volunteers across a dose-escalation design.',
        limitations:
          'PK/PD modeling study, not an efficacy/outcome trial; small, healthy-volunteer population.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary:
          'Phase II, double-blind, placebo-controlled, multiple-dose registered trial (completion date reported as December 2009 in secondary sources); no peer-reviewed results publication was identified in this review.',
        limitations:
          'No completed-with-results peer-reviewed publication identified for this trial in this review — its outcome status is unverified here.',
    ...
    },
    {
      ...
      study: {
        ...
        intervention: 'Ipamorelin',
        resultsSummary:
          'A single dose decreased time to first bowel movement; repeated dosing increased fecal pellet output, food intake, and body weight gain versus control — the preclinical basis for the human Phase II ileus trial.',
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Foundational peer-reviewed pharmacology, confirmed via human PK/PD modeling.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Ipamorelin is a synthetic growth hormone secretagogue studied for its selective activity at the ghrelin receptor',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'It is commonly studied in relation to recovery biology, exercise adaptation, body composition, and growth hormone physiology',
      disposition: 'revised',
      rationale:
        'GH physiology is directly confirmed. "Recovery biology, exercise adaptation, body composition" are not measured outcomes in the human trials identified in this review (which measured hormone PK/PD and, separately, postoperative-ileus outcomes) — these broader claims are not independently verified here.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Ipamorelin a growth hormone? A: No. Ipamorelin is a growth hormone secretagogue',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What receptor does Ipamorelin target? A: Ipamorelin is commonly studied for activity at the growth hormone secretagogue receptor',
      disposition: 'supported',
      rationale: 'Confirmed.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'established',
