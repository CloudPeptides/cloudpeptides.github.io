  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Cartalax is a peptide investigated in laboratory studies involving cartilage and connective tissue biology',
      disposition: 'unsupported',
      rationale:
        'No independently verifiable PubMed-indexed primary source for Cartalax was located during this review — see the compound-level note above. Not established as false, only as currently unverified by an authoritative source in this pipeline.',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Current research focuses on joint physiology, tissue maintenance, regenerative biology, and age-related changes in connective tissue',
      disposition: 'unsupported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Scientists investigate Cartalax for its influence on gene expression and peptide signaling associated with cartilage maintenance',
      disposition: 'unsupported',
      rationale:
        'Same finding — the specific gene-expression mechanism claimed by vendor pages (COL2A1/aggrecan upregulation) could not be traced to a verifiable primary source in this review.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Cartalax researched for? A: Published laboratory research primarily investigates cartilage biology',
      disposition: 'unsupported',
      rationale:
        'Same finding — no independently verifiable "published" research located for this specific compound.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Cartalax intended for human use? A: No. Cloud Peptides sells products strictly for laboratory research purposes only',
      disposition: 'supported',
      rationale:
        "Site-policy statement, not a scientific claim about the compound's properties; true by direct inspection of site policy.",
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [],
    },
    policyReconciliation(
      '07158aa9-c1f4-44e4-8c07-245f2e5f7c09',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      'c80d226b-4e20-46b8-894e-fde57c3033a5',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      'f69657eb-e898-4cc6-9455-3cea172077d9',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      'cc20b884-aea9-4802-b4d9-d9f648c09db7',
