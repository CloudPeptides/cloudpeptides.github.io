  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Melanotan I, also known as Afamelanotide, is a synthetic analog of alpha-melanocyte stimulating hormone (α-MSH)',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Scientific literature explores its role in melanogenesis, UV-response pathways, and dermatologic research models',
      disposition: 'supported',
      rationale: 'Accurate and consistent with the compound\'s actual approved indication (EPP photoprotection), which is precisely a UV-response/dermatologic application.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'fda-scenesse-approval', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Melanotan I is primarily studied for activation of the melanocortin-1 receptor (MC1R)',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is Melanotan I researched for? A: Research commonly focuses on pigmentation biology, melanocortin receptor signaling, UV-response pathways',
      disposition: 'revised',
      rationale: 'Accurate as far as it goes, but omits that this is not solely "research" — it has a real FDA-approved therapeutic use.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'fda-scenesse-approval', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is Melanotan I the same as Melanotan II? A: No. Although both belong to the melanocortin peptide family, they are distinct compounds',
      disposition: 'supported',
      rationale: 'Accurate and important — see melanotan-ii.mjs for that compound\'s very different (unapproved, safety-flagged) profile.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'fda-scenesse-approval', relationship: 'provides_context' }],
    },
    policyReconciliation('14496b1b-4490-4dba-9d2a-d8d21b01780b', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('35c12db3-dbd3-4cd2-9b31-e2a040b0bad5', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('690d2b83-c2da-4900-ad9d-03a52203d6cc', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    {
