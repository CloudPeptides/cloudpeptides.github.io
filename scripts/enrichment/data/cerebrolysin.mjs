  ...
  sources: [
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary:
          'Meta-analysis of 6 RCTs (n=597) found a beneficial effect of Cerebrolysin on general cognitive function (MMSE) in vascular dementia.',
        limitations:
          'Cochrane review notes trial-quality concerns are common in this literature; effect size and durability beyond the trial period were not independently re-extracted in this review.',
    ...
    },
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary:
          'Meta-analysis of 7 RCTs (n=1,779) failed to demonstrate significant superiority of Cerebrolysin over placebo on modified Rankin Scale or Barthel Index functional-outcome measures.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary:
          'Meta-analysis of 6 RCTs (n=1,649) found no significant effect on functional recovery at Day 90 compared with placebo.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      qualityRationale:
        'Cochrane systematic review — high methodological rigor — but underlying trial-quality concerns are noted by the reviewers themselves, and this is a single indication (vascular dementia), not generalizable to other uses.',
    ...
    },
    {
      ...
      evidenceQuality: 'moderate',
      qualityRationale:
        'Two independent, reasonably large meta-analyses in this specific indication both reached a null result — a genuine negative finding, not merely absence of evidence.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Cerebrolysin is a peptide-based preparation widely investigated in neurological research',
      disposition: 'supported',
      rationale:
        'Confirmed — Cerebrolysin has a large human RCT literature, unusually extensive among the compounds in this database.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
      sources: [{ sourceKey: 'cochrane-cd008900', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Laboratory and clinical research literature frequently explores Cerebrolysin in models involving brain injury, neurodegenerative processes, cognitive function, and neuronal survival pathways',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate Cerebrolysin for its neurotrophic-like activity and its potential influence on neuronal growth',
      disposition: 'supported',
      rationale:
        'Accurate mechanistic framing, correctly hedged as investigational rather than an established mechanism-to-outcome claim.',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Cerebrolysin researched for? A: Research commonly focuses on neurotrophic signaling',
      disposition: 'supported',
      rationale:
        'Accurately reflects the actual research focus, though see the mixed-results note captured in the new summary claims.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Cerebrolysin a single peptide? A: No. Cerebrolysin is typically described as a peptide-based mixture',
      disposition: 'supported',
      rationale:
        'Accurate — Cerebrolysin is a porcine-brain-derived peptide/protein mixture, not a single defined peptide, consistent with how it is described throughout the clinical literature reviewed.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [],
    },
    policyReconciliation(
      'de1a071e-b190-4681-8c87-1ef974e8752d',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      'db452e61-9319-4c16-b8af-20cb39948b59',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '2890fd77-d32f-4cde-8a6d-240272755a8c',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      'e9a18b4c-b5a4-451c-bea5-07d8ade40d51',
