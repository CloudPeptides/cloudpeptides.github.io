  ...
  sources: [
    {
      ...
      study: {
        ...
        intervention:
          'Peptide geroprotector (pituitary-gland-derived, from the Khavinson research program that also produced Epithalon)',
        resultsSummary:
          'Reported reduced markers of "rapid aging" over long-term follow-up; see epithalon-compound.mjs for the fuller, independently-researched Epithalon evidence base.',
        limitations:
          "This specific study concerns a related pituitary-derived peptide preparation, not Epithalon's own pineal-derived AEDG tetrapeptide specifically — cited here only as research-program context, not as direct Epithalon evidence.",
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'The Elite Anti-Aging Stack combines Epithalon and GHK-Cu, two compounds that have become subjects of longevity and regenerative research',
      disposition: 'revised',
      rationale:
        'Each compound individually has real research (confirmed separately for GHK-Cu in the pilot; confirmed for the Khavinson pituitary/pineal peptide research program here). The claim that this SPECIFIC PAIRING is studied for "healthy aging, cellular maintenance" overstates what is verifiable — no combination study exists.',
      evidenceQuality: 'low',
      interpretationStatus: 'insufficient',
      sources: [{ sourceKey: 'pmid-22451889-stack', relationship: 'provides_context' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Although they influence different biological systems, researchers are interested in how these complementary mechanisms may interact in laboratory models',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Research remains ongoing, and findings should always be interpreted within the context of peer-reviewed scientific literature',
      disposition: 'supported',
      rationale:
        "Generic, appropriately cautious statement, consistent with this review's findings.",
      evidenceQuality: 'not_assessed',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate Epithalon and GHK-Cu together because each has been associated with different aspects of longevity biology',
      disposition: 'unsupported',
      rationale:
        'No source investigating the two "together" was located; each has been investigated independently.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why are Epithalon and GHK-Cu researched together? A: Researchers investigate this pairing because each compound is associated with different areas',
      disposition: 'revised',
      rationale:
