  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations: 'Nausea, flushing, and headache occurred in >=10% of patients on bremelanotide in both trials, more frequently than placebo.',
    ...
    },
    {
      ...
      study: {
        ...
        comparator: 'Placebo',
        resultsSummary: 'An earlier trial reporting an effect on subjective sexual response — foundational human evidence preceding the later pivotal Phase 3 program.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'PT-141, also known as Bremelanotide, is a synthetic melanocortin peptide investigated for neuroendocrine signaling and reproductive biology',
      disposition: 'revised',
      rationale: 'Accurate mechanistically, but omits that this compound is FDA-approved (Vyleesi) — a significant regulatory fact, consistent with the pattern seen for Botulinum Toxin, HCG, and Melanotan I in earlier batches.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Laboratory studies explore PT-141 in models involving melanocortin receptor biology, neuroendocrine regulation, behavioral neuroscience, and reproductive physiology',
      disposition: 'revised',
      rationale: 'Understates the evidence level — this is not merely "laboratory studies" but real Phase 3 human randomized controlled trials underlying an FDA approval.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-31599840', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate PT-141 for its interaction with melanocortin receptors, particularly within central nervous system pathways',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is PT-141 researched for? A: Research commonly focuses on melanocortin receptor signaling, neuroendocrine biology, reproductive physiology',
      disposition: 'revised',
      rationale: 'Accurate but understates the actual clinical/regulatory status — it is an approved drug for a specific indication (HSDD), not solely a research subject.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-31599840', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Why is PT-141 also called Bremelanotide? A: Bremelanotide is the commonly used scientific and pharmaceutical name for PT-141',
      disposition: 'supported',
      rationale: 'Accurate and confirmed by all verified sources, which use "bremelanotide" as the formal name.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-31599840', relationship: 'directly_supports' }],
    },
    policyReconciliation('78f38b31-05c0-4101-b43e-9cb4be127788', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('b758ceef-88d2-4ce7-9ed2-61d2e61dceb7', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('47076004-17bd-4902-b3f0-c2bd5d742e4d', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    {
