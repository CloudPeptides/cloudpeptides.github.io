...
export default {
  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          "Phase III, multicenter, randomized, double-blind, placebo-controlled trial — one of the pivotal studies underlying Thymosin Alpha-1's approval as a hepatitis B treatment in numerous countries.",
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Well-established mechanism, supported by an extensive human clinical trial literature across multiple indications.',
  ...
  regulatoryRecords: [
    {
      agency:
        'Multiple national regulators (35+ countries, e.g. China, India, Philippines, Russia)',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Thymosin Alpha-1 is a naturally occurring peptide originally isolated from the thymus. It is widely studied for its role in immune regulation',
      disposition: 'revised',
      rationale:
        'Accurate mechanistically, but frames Thymosin Alpha-1 purely as a "studied" research subject, when it is in fact an approved prescription drug in 35+ countries — a significant regulatory fact, added as new regulatory claims/records above.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-10607256', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers continue to investigate its effects on immune signaling, inflammatory pathways, and recovery-related biological processes',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Current research explores how Thymosin Alpha-1 influences immune cell communication, antigen presentation, and cytokine signaling',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Thymosin Alpha-1 researched for? A: Published research commonly investigates immune regulation, T-cell biology, inflammation-related signaling',
      disposition: 'revised',
      rationale:
        'Accurate but incomplete — omits the significant fact that it is an approved drug (outside the US) for specific indications, not solely a research subject.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-10607256', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is Thymosin Alpha-1 naturally occurring? A: Yes. It is a naturally occurring peptide associated with the thymus',
      disposition: 'supported',
