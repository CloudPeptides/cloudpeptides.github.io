  ...
  sources: [
    {
      ...
      study: {
        ...
        intervention: 'Peptide geroprotector (pituitary-gland-derived preparation, from the same Khavinson research program)',
    ...
    },
    {
      ...
      study: {
        ...
        intervention: 'Epithalamin (bovine pineal peptide extract; Epithalon\'s AEDG sequence was derived from this preparation)',
        resultsSummary: 'A course of Epithalamin normalized/increased nighttime plasma melatonin concentration in subjects with initially reduced pineal activity.',
        limitations: 'Studies Epithalamin (an extract/preparation), not confirmed identical to the synthesized four-amino-acid Epithalon alone; same research group.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        resultsSummary: '20-year review of the research group\'s own experimental gerontology and oncology (animal + some human) findings on Epithalamin.',
        limitations: 'Narrative review by the compound-preparation\'s own developers — self-review, not independent; animal findings should not be read as human efficacy.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        studyDesign: 'narrative_review',
        resultsSummary: 'Recent (2025), independent (non-Khavinson-group) narrative review summarizing proposed antioxidant, neuroprotective, antimutagenic, and geroprotective mechanisms of Epitalon, drawing on the existing (mostly animal/observational) literature.',
        limitations: 'Narrative, not systematic review; summarizes rather than independently replicates the underlying primary evidence.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Human observational/small-trial evidence exists (unusual for this database), but from a single research program without independent outside replication identified, and concerning a related preparation rather than confirmed to be the isolated tetrapeptide itself.',
    ...
    },
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Narrative (non-systematic) review; underlying primary evidence is largely from one research group.',
      interpretationStatus: 'preliminary',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Epithalon is a synthetic tetrapeptide commonly investigated in longevity and healthy aging research',
      disposition: 'supported',
      rationale: 'Confirmed research focus, though the strongest human evidence concerns the related Epithalamin preparation rather than confirmed-identical isolated Epithalon — noted in the new summary claim.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers continue to study Epithalon in laboratory settings to better understand peptide signaling pathways',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Epithalon is investigated for its potential influence on regulatory pathways involved in pineal function, circadian signaling, and cellular aging',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is Epithalon researched for? A: Research commonly focuses on healthy aging, pineal gland biology, circadian rhythm, melatonin signaling',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is Epithalon a standalone peptide? A: Yes. Epithalon is a standalone tetrapeptide',
      disposition: 'revised',
      rationale: 'Chemically accurate (Epithalon/Epitalon is a defined AEDG tetrapeptide), but most of the human evidence identified in this review concerns Epithalamin (a peptide-extract preparation), not confirmed to be pharmacologically identical to the isolated tetrapeptide — this distinction should be surfaced to avoid overstating what the human evidence actually covers.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-8010617', relationship: 'provides_context' }],
    },
    policyReconciliation('c29316c1-3272-473f-8681-30c9c3c10bcd', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('53bd7c76-52ae-40df-8ca2-2cfc0b844773', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('c6bef697-987d-477f-9b36-cb3396ee9546', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('b5882374-ae4a-47d2-a65a-e76f8242e17c', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
