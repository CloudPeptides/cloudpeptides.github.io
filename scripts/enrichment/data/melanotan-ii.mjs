  ...
  sources: [
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary: 'Reported systemic toxicity and rhabdomyolysis following Melanotan II injection.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        limitations: 'Case report(s) — establishes temporal association, not proven causation; melanoma has multifactorial causes including UV exposure, which is often co-occurring in melanotan users seeking a tan.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Melanotan II is a synthetic analog of α-melanocyte stimulating hormone (α-MSH) investigated for its interaction with melanocortin receptors',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Scientific literature investigates receptor activation, skin pigmentation biology, UV-response pathways, and broader melanocortin receptor function',
      disposition: 'revised',
      rationale: 'Accurate as far as mechanistic research goes, but again omits the real human safety case-report literature that is a defining feature of this specific compound\'s evidence base.',
      evidenceQuality: 'low',
      interpretationStatus: 'conflicting',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers investigate Melanotan II for activation of melanocortin receptors, particularly MC1R and MC4R',
      disposition: 'supported',
      rationale: 'Mechanistically accurate — MC4R activation is the proposed mechanism for the priapism cases specifically.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: How is Melanotan II different from Melanotan I? A: Although both are melanocortin analogs, they differ in receptor activity',
      disposition: 'revised',
      rationale: 'Accurate but understates the difference: Melanotan I\'s FDA-approved form has controlled clinical use with a defined safety profile; Melanotan II has no approval and a real published case-report literature of serious adverse events from unregulated use. This is a materially more important distinction than "differ in receptor activity" conveys.',
      evidenceQuality: 'low',
      interpretationStatus: 'conflicting',
      sources: [{ sourceKey: 'pmid-23537392', relationship: 'directly_supports' }],
    },
    policyReconciliation('87c1c2ab-f7d5-4303-9491-f1bcca582f79', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('7de3f9e5-bf82-4bb9-9c89-10464f0d57c5', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('6115cb3a-63c1-47d3-8710-7c7e9544ab07', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('91398296-d957-4ecf-bb9e-ad5637ec68a0', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
