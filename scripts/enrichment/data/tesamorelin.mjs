  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations: 'Studied specifically in HIV-associated lipodystrophy — findings should not be generalized to other populations seeking visceral-fat reduction without that condition.',
  ...
  claims: [
    {
      ...
      qualityRationale: 'Well-established mechanism confirmed by the FDA-approved product\'s own labeling and multiple Phase 3 trials.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Tesamorelin is a synthetic analog of growth hormone-releasing hormone (GHRH)',
      disposition: 'revised',
      rationale: 'Accurate mechanistically, but frames Tesamorelin purely as a research subject when it is in fact an FDA-approved drug (Egrifta, since 2010) for a specific indication — added as a new regulatory claim/record above.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'fda-egrifta-approval', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Current scientific literature explores its role in body composition, visceral adipose tissue biology, endocrine signaling, and metabolic health',
      disposition: 'supported',
      rationale: 'Directly confirmed — visceral adipose tissue reduction is precisely the FDA-approved, pivotal-trial-demonstrated effect.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-25038357', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Tesamorelin binds to GHRH receptors in the pituitary, stimulating the body\'s own release of growth hormone',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is Tesamorelin a growth hormone? A: No. Tesamorelin is a GHRH analog that stimulates endogenous growth hormone release',
      disposition: 'supported',
    ...
    policyReconciliation('0c88f52e-744e-4d28-b07a-4b4b4bb9a65d', 'Q: Does this page include dosage recommendations? A: No.'),
    policyReconciliation('9301b8bf-47ef-4be6-b5e3-18b3183ab072', 'Q: What is this page for? A: This page summarizes publicly available scientific literature'),
    policyReconciliation('cffd3b10-7815-4d54-86ac-67e6ac7543af', 'This page summarizes published scientific literature for educational purposes only.'),
    policyReconciliation('0c0c26be-674a-4ced-8629-da6b35dd082d', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    {
