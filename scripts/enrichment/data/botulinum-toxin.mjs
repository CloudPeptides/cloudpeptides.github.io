  ...
  claims: [
    {
      ...
      qualityRationale:
        'Foundational, extensively replicated mechanistic finding published in a top-tier journal (Nature) and confirmed across decades of subsequent molecular biology research.',
  ...
  regulatoryRecords: [
    {
      ...
      formulation:
        'OnabotulinumtoxinA (BOTOX) for injection, manufactured by Allergan (an AbbVie company)',
      indication:
        'Multiple — initially essential blepharospasm/strabismus/hemifacial spasm; later expanded to cervical dystonia, cosmetic glabellar lines, chronic migraine, overactive bladder, and others',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Botulinum toxin is a bacterial neurotoxin extensively investigated in neuroscience, neuromuscular physiology, and synaptic biology',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Experimental models examine botulinum toxin in studies of peripheral nerves, synaptic transmission, motor neuron function, and neurophysiology',
      disposition: 'supported',
      rationale:
        'Accurate description of the mechanistic research base, consistent with the verified SNAP-25 cleavage literature.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-8103915', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate botulinum toxin for its ability to interfere with SNARE proteins involved in acetylcholine release',
      disposition: 'supported',
      rationale:
        'Precisely matches the verified, foundational SNAP-25/SNARE mechanistic literature.',
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-8103915', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What is Botulinum Toxin researched for? A: Research commonly focuses on neuromuscular signaling',
      disposition: 'supported',
      rationale:
        "Consistent with the verified mechanistic literature, though — as with the summary claim above — the compound's status as an approved therapeutic (not solely a research subject) is materially relevant context added elsewhere in this file.",
      evidenceQuality: 'high',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-8103915', relationship: 'directly_supports' }],
    },
    policyReconciliation(
      '38f1fbbf-cc9a-447a-ba96-ecc9083767e6',
      'Q: Is this page intended as medical guidance? A: No.',
    ),
    policyReconciliation(
      '78122aa4-fa40-470a-abfb-2a0efdbce6af',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      '58150996-39dd-41e1-9c50-72921c5925d5',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '1abb128f-60ea-4539-ba8f-be4b8a0d895f',
