  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'The Wolverine Stack is the nickname commonly used for the research combination of BPC-157 and TB-500. Researchers study these compounds because they are believed to influence different biological processes',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Rather than targeting a single pathway, the combination is explored to better understand how multiple regenerative mechanisms may complement one another',
      disposition: 'unsupported',
      rationale:
        'No source exploring "the combination" (as opposed to each compound independently) was located — same finding as bpc-157-tb-500.mjs.',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Research is ongoing, and conclusions should be interpreted within the context of individual study design and the current scientific literature',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'BPC-157 and TB-500 are frequently investigated together because they are associated with different aspects of tissue repair biology',
      disposition: 'unsupported',
      rationale:
        'No source investigating them "together" was located — each has been studied independently. Same finding as bpc-157-tb-500.mjs.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why is it called the Wolverine Stack? A: The nickname comes from the fictional character Wolverine, known for rapid healing. It is simply a nickname used within the research community',
      disposition: 'supported',
      rationale:
        'Accurate, non-scientific naming-convention fact — appropriately transparent that this is a colloquial nickname, not a scientific designation.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [],
    },
    policyReconciliation(
      '7f0a1c5c-af3d-4290-8676-83f80a7f6db2',
      'Q: Does Cloud Peptides recommend this stack? A: No.',
    ),
    policyReconciliation(
      '00255484-eaff-41f4-adbc-7642b418e372',
      'Q: Does this article provide dosage information? A: No.',
    ),
    policyReconciliation(
      '4cf04cbc-e341-4f79-b6e9-a09b32cfe8f1',
      'Q: Are these products intended for human consumption? A: No.',
    ),
    policyReconciliation(
      '733afb90-6fe9-42f1-bf93-13e9893c4d3c',
      'The information on this page is provided for educational purposes only and summarizes published scientific literature.',
    ),
    policyReconciliation(
      'ba75be10-418b-40ef-9358-3b5080fff374',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage guidance.',
    ),
    policyReconciliation(
      'bd4f10f8-6cb4-40b8-aa7c-c06b5f1422fe',
