  ...
  sources: [
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary: 'Reviews Selank\'s proposed anxiolytic mechanism (GABAergic modulation, allosteric GABA-A receptor interaction) and preclinical/clinical findings.',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary: 'Eliminated withdrawal-induced anxiety (elevated plus maze, social interaction tests) and prevented mechanical allodynia, without affecting ethanol consumption itself.',
  ...
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale: 'Real human observational data exists (a strength relative to many compounds in this database), but design rigor (randomization/blinding) could not be confirmed from the abstract, and no rigorous placebo-controlled human RCT was independently verified in this review.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'Selank is a synthetic peptide investigated in neuroscience and behavioral research',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers continue to examine Selank in laboratory models involving central nervous system function, behavioral adaptation, and peptide-mediated regulation',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Selank is studied for its potential influence on neuropeptide signaling, neurotransmitter systems, and immune-related pathways',
      disposition: 'supported',
      rationale: 'Directly confirmed — the human study specifically reports immunomodulatory effects, and the review source describes GABAergic/neurotransmitter mechanisms.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [
        { sourceKey: 'pmid-18577961', relationship: 'directly_supports' },
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is Selank researched for? A: Research commonly focuses on neurobiology, stress-response pathways, cognitive models, neurotransmitter systems, and immune-neural signaling',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is Selank related to Semax? A: They are distinct regulatory peptides, but both are commonly discussed within cognitive and neurological research categories',
      disposition: 'supported',
      rationale: 'Accurate — both are real, independently verified Russian regulatory peptides with distinct sequences/mechanisms (see semax.mjs).',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-30255741-selank', relationship: 'provides_context' }],
    },
    policyReconciliation('eecbe24e-8e46-4291-ac4e-6ad12d660838', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('f718dcfc-4202-4be0-8052-c6233bce93a2', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('e190f283-cef7-4ee7-b6c1-ac92faa4336a', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('d15b62a2-f728-4178-bd2e-84e4e9bbe956', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
