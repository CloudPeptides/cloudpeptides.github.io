  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary:
          'LONG R3IGF-I acted as a more potent growth/survival factor than either insulin or native IGF-1 in serum-free HEK293 cell culture, at lower concentrations — its intended biomanufacturing use case.',
        limitations:
          'Cell-culture reagent-development study, not a physiological or clinical outcome study.',
    ...
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'Stimulated organ growth in vivo but simultaneously REDUCED endogenous plasma IGF-I, IGF-II, and IGF-binding protein concentrations — a notable, potentially counterintuitive systemic finding.',
        limitations:
          'Animal (guinea pig) study; a single-species finding not independently replicated in this review.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale:
        'Real peer-reviewed in-vitro and animal evidence exists, but no human trial was located, and the animal finding on endogenous IGF suppression is a single-species result.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'IGF-1 LR3 is a modified analog of insulin-like growth factor-1 that has become an important research tool in studies involving muscle physiology',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers investigate how prolonged IGF-1 receptor activation influences muscle adaptation, protein synthesis, body composition, and recovery',
      disposition: 'unsupported',
      rationale:
        'No source specific to IGF-1 LR3 (as opposed to native IGF-1 generally) evaluating muscle adaptation, protein synthesis, body composition, or recovery in vivo (animal or human) was located in this review.',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'IGF-1 LR3 binds to the IGF-1 receptor, initiating signaling pathways involved in cellular growth, survival, and protein synthesis',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What receptor does IGF-1 LR3 target? A: Researchers primarily investigate its interaction with the IGF-1 receptor',
      disposition: 'supported',
      rationale: 'Confirmed.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Is IGF-1 LR3 the same as growth hormone? A: No. IGF-1 LR3 is a modified insulin-like growth factor researched separately from growth hormone',
      disposition: 'supported',
      rationale:
        'Accurate — IGF-1 LR3 and growth hormone are distinct molecules with distinct receptors, consistent with the verified biology.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [],
    },
    policyReconciliation(
      'babc1f98-d698-48d9-ae31-cc851face545',
      'Q: Does this page provide dosage information? A: No.',
    ),
    policyReconciliation(
      '58afe99f-5d9c-4134-8b9d-e3ae479c7686',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '5f64b223-8a49-4b94-9c66-75620b5c6268',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      '4665f878-9868-42b1-adc9-83cda207bc8f',
