...
export default {
  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations:
          'Animal model only; TB-500 (a synthetic fragment/analog) is not always identical to the natural full-length thymosin beta-4 peptide used in this study.',
    ...
    },
    {
      ...
      study: {
        ...
        limitations:
          'Narrative (non-systematic) review; underlying primary studies are animal-only.',
        peerReviewStatus: 'peer_reviewed',
      },
    },
    {
      ...
      study: {
        ...
        resultsSummary:
          'BPC 157 accelerated tendon explant outgrowth, increased fibroblast survival under oxidative stress, and increased fibroblast migration (see bpc-157.mjs for the fuller BPC-157 evidence base).',
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    ...
    },
    {
      ...
      qualityRationale:
        'Peer-reviewed animal studies; TB-500 as commercially sold is a synthetic peptide related to but not always identical to the natural thymosin beta-4 used in the cited research — this distinction was not independently resolved in this review.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'BPC-157 and TB-500 are frequently studied together because they are associated with different biological processes involved in tissue repair',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Scientific literature continues to evaluate how these pathways interact across musculoskeletal, soft tissue, and vascular research models',
      disposition: 'unsupported',
      rationale:
        "No literature evaluating the interaction of these two peptides' pathways (as opposed to each pathway independently) was located during this review.",
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'insufficient',
      sources: [],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why are BPC-157 and TB-500 researched together? A: Researchers investigate this pairing because each compound has been studied for different aspects',
      disposition: 'revised',
      rationale:
        "More accurate as written than the summary claim above — it correctly attributes the rationale to each compound's SEPARATE research base rather than claiming the pairing itself has been researched. Retained with this distinction now made explicit in the new summary claim.",
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [
        { sourceKey: 'pmid-21030672-blend', relationship: 'provides_context' },
    ...
    policyReconciliation(
      '4a71eb12-48b8-44b7-8e90-09d9e14d6513',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      '442f3a2d-2c55-42b8-a90a-2b8279677a7a',
      'Q: What is the purpose of this page? A: This page summarizes publicly available scientific literature',
    ),
    policyReconciliation(
      '1fdaf81a-e3fd-49b5-948c-7d1bce5004fa',
      'This page summarizes published scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '635a0160-8385-4a9a-82dd-f68c3a4843e2',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      'ff461eeb-3496-4157-aef5-f34ddc5f64a3',
