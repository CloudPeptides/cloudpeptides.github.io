  ...
  sources: [
    {
      ...
      study: {
        ...
        limitations:
          'Narrative (non-systematic) review, though summarizing a genuinely broad, decades-deep, independently-replicated literature (not limited to one research group).',
    ...
    },
    {
      ...
      study: {
        studyDesign: 'narrative_review',
        resultsSummary:
          "Authored by Thymalin's own developers (Morozov, Khavinson); reviews thymic peptide preparations (including Thymalin, isolated from calf thymus) as immune-dysfunction therapeutics.",
        limitations:
          "Authored by the compound's own developers — a direct conflict of interest, the same limitation pattern seen for Epithalon/Cartalax/Pinealon in this database.",
        peerReviewStatus: 'peer_reviewed',
      },
    },
  ],
  claims: [
    {
      ...
      evidenceQuality: 'low',
      qualityRationale:
        "Thymulin's evidence is comparatively strong (independent, replicated); Thymalin's is comparatively weak (self-authored). Presenting them as a single evidentiary unit understates this real difference.",
    ...
    },
    {
      ...
      qualityRationale:
        'Well-characterized, independently replicated mechanism across a broad literature spanning decades.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'Thymalin and Thymulin are thymus-derived peptides studied for their roles in immune system biology and age-related changes in thymic function',
      disposition: 'revised',
      rationale:
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Current literature explores their potential influence on thymic activity, immune cell development, and recovery-related biological pathways',
      disposition: 'revised',
      rationale:
        'Thymic activity/immune cell development is directly confirmed for Thymulin specifically; "recovery-related biological pathways" was not independently verified as a distinct studied outcome for either compound in this review.',
      evidenceQuality: 'low',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Researchers study Thymalin and Thymulin for their effects on thymus-associated signaling pathways, T-cell maturation, cytokine regulation',
      disposition: 'supported',
      rationale:
        'T-cell maturation/differentiation effects are directly confirmed, primarily for Thymulin.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'supported',
      sources: [{ sourceKey: 'pmid-19236333', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What are Thymalin and Thymulin researched for? A: Research commonly focuses on thymus biology, immune regulation, T-cell development, and healthy aging',
      disposition: 'supported',
      rationale:
        'Accurately reflects the research focus, with the evidence-strength caveat noted above.',
      evidenceQuality: 'low',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-19236333', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Are these the same peptide? A: No. They are distinct thymic peptides that are frequently discussed together because of their related biological functions',
      disposition: 'supported',
      rationale:
        'Correct that they are chemically distinct — though this review found their EVIDENCE BASES are also meaningfully distinct (not just their chemistry), which this FAQ does not mention.',
      evidenceQuality: 'not_assessed',
      interpretationStatus: 'established',
      sources: [{ sourceKey: 'pmid-19236333', relationship: 'provides_context' }],
    },
    policyReconciliation(
      '58f32240-00ac-4702-a215-98ef8b0bff0b',
      'Q: Does Cloud Peptides provide dosage information? A: No.',
    ),
    policyReconciliation(
      '73ef37f1-d683-42e2-a6ae-0e84a391d630',
      'This page summarizes publicly available scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      '8702d035-1deb-4c74-96ac-093902044768',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      'ff2eebb9-28c0-40c7-9218-7de83f3d1682',
