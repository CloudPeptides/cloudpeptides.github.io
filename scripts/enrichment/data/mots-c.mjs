  ...
  sources: [
    {
      ...
      study: {
        ...
        population:
          'Mice (aged and diet-induced obese models) and cell lines (HEK293, skeletal muscle)',
        intervention:
          'MOTS-c (16-amino-acid peptide encoded within mitochondrial 12S rRNA), administered exogenously',
        resultsSummary:
        ...
        limitations:
          'Foundational, highly-cited mouse study; no human trial identified in this review.',
  ...
  claims: [
    {
      ...
      qualityRationale:
        'Published in a top-tier journal (Cell Metabolism) and highly cited, but a single foundational mouse study — no independent human replication identified in this review.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt:
        'MOTS-c is a naturally occurring mitochondrial-derived peptide that has become an important area of research in metabolism, exercise physiology, and healthy aging',
      disposition: 'supported',
      rationale:
        'Confirmed unique mitochondrial-DNA-encoded origin and metabolic research focus, though the "exercise physiology" specific claim was not directly verified as its own dedicated study in this review (the foundational study covers metabolic homeostasis/insulin sensitivity, not exercise performance specifically).',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-25738459', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt:
        'Scientists continue investigating its potential role in regulating cellular energy utilization, metabolic flexibility, mitochondrial communication',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Current research suggests MOTS-c participates in cellular stress responses and metabolic adaptation',
      disposition: 'supported',
      rationale: 'Confirmed.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: What makes MOTS-c unique? A: MOTS-c is one of the few biologically active peptides encoded by mitochondrial DNA',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt:
        'Q: Why is MOTS-c found in two categories? A: Researchers investigate MOTS-c for both metabolic regulation and healthy aging',
      disposition: 'supported',
      rationale:
        'Consistent with the verified foundational study, which covers both metabolic (insulin sensitivity, obesity) and aging (age-dependent insulin resistance in old mice) findings.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-25738459', relationship: 'directly_supports' }],
    },
    policyReconciliation(
      '9699e842-221c-4c94-90cc-52a04165e7dd',
      'Q: Does Cloud Peptides provide dosage recommendations? A: No.',
    ),
    policyReconciliation(
      '568cb511-a9e0-499e-a934-d0f65764cf27',
      'This page summarizes published scientific literature for educational purposes only.',
    ),
    policyReconciliation(
      'b5aa5503-49f4-40d3-b8c7-d2afd80d0c3e',
      'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.',
    ),
    policyReconciliation(
      '13ba3db0-c1ef-45f7-b1d8-cce09e66eb23',
