  ...
  sources: [
    {
      ...
      study: {
        ...
        resultsSummary: 'Demonstrated that most of alpha-MSH\'s anti-inflammatory activity is attributable specifically to its C-terminal tripeptide KPV; KPV likely does not act through classical melanocortin receptors.',
  ...
  claims: [
    {
      ...
      qualityRationale: 'Peer-reviewed mechanistic and animal-model studies from independent research groups with a consistent direction of effect.',
    ...
    },
    {
      ...
      evidenceQuality: 'moderate',
      qualityRationale: 'Peer-reviewed animal study in a top gastroenterology journal, but animal-only — no human trial identified.',
  ...
  legacyReconciliations: [
    {
      ...
      legacyStatementExcerpt: 'KPV is a short peptide sequence derived from alpha-melanocyte-stimulating hormone research',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Researchers continue to study KPV in relation to skin barrier function, gastrointestinal tissue, recovery biology, and cellular inflammatory pathways',
      disposition: 'revised',
      rationale: 'Gastrointestinal/colitis and inflammatory-pathway evidence is directly confirmed (animal only). No skin-barrier-specific or "recovery biology" study of KPV specifically was located in this review — those sub-claims are not independently verified here.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-18061177', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'KPV is studied for interactions with inflammatory and immune-related pathways',
      disposition: 'supported',
    ...
    },
    {
      ...
      legacyStatementExcerpt: 'Q: What is KPV commonly researched for? A: KPV is commonly researched for inflammation-related pathways, immune signaling, epithelial tissue biology, skin barrier research, and gastrointestinal models',
      disposition: 'revised',
      rationale: 'Inflammation, immune signaling, and gastrointestinal models are directly confirmed. "Skin barrier research" specifically was not located as a KPV-specific source in this review.',
      evidenceQuality: 'moderate',
      interpretationStatus: 'preliminary',
      sources: [{ sourceKey: 'pmid-18061177', relationship: 'directly_supports' }],
    },
    {
      ...
      legacyStatementExcerpt: 'Q: Is KPV a large peptide? A: No. KPV is a short tripeptide sequence',
      disposition: 'supported',
    ...
    policyReconciliation('a917ed0a-b30c-4203-9d67-278bccd196bb', 'Q: Does Cloud Peptides provide dosage information? A: No.'),
    policyReconciliation('a6391fe7-20c1-4577-b052-a641cc12c688', 'This page summarizes publicly available scientific literature for educational purposes only.'),
    policyReconciliation('b886ce65-ac49-4aca-9098-bf439c255527', 'Cloud Peptides does not provide medical advice, treatment recommendations, or dosage information.'),
    policyReconciliation('1024cebc-8fc4-4b2f-a5af-6f1749cf961d', 'All products are intended strictly for laboratory research purposes only'),
  ],
};
