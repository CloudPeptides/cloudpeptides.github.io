...
- Use a staging Supabase project until production access is explicitly approved.
- Never connect to, query, migrate, or modify the production Supabase project without explicit authorization.
